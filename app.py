...
def load_model():
    try:
        model = tf.keras.models.load_model(r'C:\Users\ROSHNI\OneDrive\Desktop\Rosh_Digit\mnist_model_enhanced.h5')
...
st.markdown('<div class="footer"><div class="footer-line">Brought to you by</div><div class="footer-name">Roshni Ruchika</div></div>', unsafe_allow_html=True)
